...
requirejs.config({
  ...
  config: {
    ...
    // set default lang, if browser agent support languages, choose the first item, if not used browser user language
      ...
      self.dynamicConfig = ko.pureComputed(function () {
        if (self.smallOnly()) {
          return {
            ...
            lifecycleListner: router.moduleConfig.lifecycleListner,
            params: router.moduleConfig.params
          };
        }
